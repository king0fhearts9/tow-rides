      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-40 flex items-center gap-3 rounded-full border-2 border-black bg-primary px-5 py-3 font-semibold uppercase tracking-wide text-white shadow-[0_20px_40px_rgba(0,0,0,0.25)] transition hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-primary/40"
            aria-label="Need instant chat"
          >
            <FiMessageSquare className="text-xl" />
            <span>Need Instant Chat?</span>
          </motion.button>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-[340px] max-w-[90vw]"
          >
            <div className="overflow-hidden rounded-3xl border-2 border-black bg-white shadow-[0_26px_60px_rgba(0,0,0,0.18)]">
              ...
              <div className="flex max-h-[360px] flex-col gap-4 px-5 py-5 text-sm text-accent-black/80">
                <div
                  ref={containerRef}
              ...
              <div className="border-t border-black/10 bg-black/5 px-5 py-3 text-[11px] uppercase tracking-[0.3em] text-accent-black/60">
                24/7 command center
              </div>
            </div>
          </motion.div>
