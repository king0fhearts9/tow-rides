...
const baseClasses =
  "inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 font-semibold uppercase tracking-wide transition-all duration-300 ease-smooth focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 hover:-translate-y-0.5";

const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-primary text-accent-white border-2 border-black hover:bg-primary/90 hover:text-accent-white hover:border-black",
  secondary:
    "bg-accent-white text-accent-black border-2 border-black hover:bg-primary hover:text-accent-white",
  ghost:
    "bg-transparent text-accent-black border-2 border-black hover:bg-primary hover:text-accent-white",
};
